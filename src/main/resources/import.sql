...
INSERT INTO `foto` (`id`, `description`, `picture_url`, `title`, `visible`, `created_at`, `updated_at`, `user_id`) VALUES (NULL, 'Ritratto di donna anziana.', 'https://picsum.photos/200/300?random=3', 'Donna anziana in vestaglia', true, '2020-11-11', '2020-11-12', 2);
INSERT INTO `foto` (`id`, `description`, `picture_url`, `title`, `visible`, `created_at`, `updated_at`, `user_id`) VALUES (NULL, 'Via del Corso a Roma', 'https://picsum.photos/200/300?random=4', 'Passeggiando per via del Corso', true, '2020-11-11', '2020-11-12', 2);
